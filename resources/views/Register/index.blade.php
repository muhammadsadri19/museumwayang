    ...
    <div class="col-lg-5">
      <main class="form-register">
        ...
        <form action="/register" method="post">
          ...
          <button class="w-100 btn btn-lg-0 btn-dark mt-4" style="background-color: #143784;" type="submit">Register</button>
        </form>
        <small class="register d-block text-center mt-1">Have an account?<a href="/login">Login Here!</a></small>
      </main>
    </div>
  </div>
</div>
